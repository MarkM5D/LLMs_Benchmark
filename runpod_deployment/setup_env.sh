...
# vLLM installation - H100 Optimized
echo "⚡ Installing vLLM with H100 optimizations..."
# For H100, we need to compile vLLM with Hopper support
export VLLM_NCCL_SO_PATH=/usr/local/cuda/lib64/libnccl.so
